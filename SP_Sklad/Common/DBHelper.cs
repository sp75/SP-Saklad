...
namespace SP_Sklad.Common
{
    ...
    public static class DBHelper
    {
        ...
        {
            return new SPBaseModel().Database.SqlQuery<DateTime>("SELECT getdate()").FirstOrDefault();
        }
        ...
        public static List<Countries> CountersList
        {
            get
            {
                if (_counters == null)
                {
                    _counters = new SPBaseModel().Countries.ToList();
                }
                return _counters;
            }
        }
        ...
        public static List<DocType> DocTypeList
        {
            get
            {
                if (_doc_type == null)
                {
                    _doc_type = new SPBaseModel().DocType.ToList();
                }
                return _doc_type;
            }
        }
        ...
        public static List<Measures> MeasuresList
        {
            get
            {
                if (_measures == null)
                {
                    _measures = new SPBaseModel().Measures.ToList();
                }
                return _measures;
            }
        }
        ...
        public static CommonParams CommonParam
        {
            get
            {
                ...
                {
                    _common_param = new SPBaseModel().CommonParams.FirstOrDefault();
                }
        ...
        public static LoginUser CurrentUser
        {
            get
            {
                ...
                return _current_user = new SPBaseModel().Users.Where(w => w.UserId == mainForm.user_id).ToList().Select(s => new LoginUser
                {
                    UserId = s.UserId,
                    Name = s.Name,
                    Pass = s.Pass,
        ...
        public static Enterprise Enterprise
        {
            get
            {
                if (_enterprise == null)
                {
                    _enterprise = new SPBaseModel().Kagent.Where(w => w.KType == 3 && w.KaId == mainForm.enterprise_id).Select(s => new Enterprise
                    {
                        KaId = s.KaId,
                        Name = s.Name,
                        NdsPayer = s.NdsPayer
        ...
        public static List<PayType> PayTypes
        {
            get
            {
                if (_pay_type == null)
                {
                    _pay_type = new SPBaseModel().PayType.ToList();
                }
                return _pay_type;
            }
        }
        public static List<CashDesks> CashDesks
        {
            get
            {
                if (_cash_desks == null)
                {
                    _cash_desks = new SPBaseModel().GetUserAccessCashDesks(CurrentUser.UserId).ToList().Where(w=> w.Allow == 1)/*.Where(w => w.EnterpriseId == Enterprise.KaId)*/.Select(s => new CashDesks
                    {
                        CashId = s.CashId,
                        Name = s.Name,
                        Def = s.Def,
        ...
        public static List<CashDesks> AllCashDesks
        {
            get
            {
                return new SPBaseModel().CashDesks.ToList();
            }
        }
        ...
        public static List<ChargeType> ChargeTypes
        {
            get
            {
                ...
                {
                    _charge_type = new SPBaseModel().ChargeType.Where(w => w.Deleted == 0).ToList();
                }
                return _charge_type;
            }
        }
        ...
        public static List<WhList> WhList
        {
            get
            {
                if (_wh_list == null)
                {
                    _wh_list = new SPBaseModel().Warehouse.Where(w => w.Deleted == 0  && w.UserAccessWh.Any(u => u.UserId == CurrentUser.UserId) ).Select(s => new WhList { WId = s.WId, Name = s.Name, Def = s.Def }).ToList();
                }
                return _wh_list;
            }
        ...
        public static List<Packaging> Packaging
        {
            get
            {
                if (_packaging == null)
                {
                    _packaging = new SPBaseModel().Packaging.ToList();
                }
                return _packaging;
            }
        }
        ...
        public static List<Currency> Currency
        {
            get
            {
                if (_currency == null)
                {
                    _currency = new SPBaseModel().Currency.ToList();
                }
                return _currency;
            }
        }
        ...
        public static int? StornoOrder(SPBaseModel db, int wbill_id)
        {
        ...
        public static ExecuteWayBill_Result ExecuteOrder(SPBaseModel db, int wbill_id)
        {
        ...
        public static bool CheckInDate(WaybillList wb, SPBaseModel db, DateTime date)
        {
            bool r = true;
        ...
        public static bool CheckOutDate(WaybillList wb, SPBaseModel db, DateTime date)
        {
            bool r = true;
...
order by wbd.ondate desc
        ...
        public static bool CheckOrderedInSuppliers(int wbill_id, SPBaseModel db)
        {
            bool r = true;
        ...
        public static bool IsAnyChanges(this SPBaseModel context)
        {
        ...
        public static int Save(this SPBaseModel db, int wb_id)
        {
            using (var _db = new SPBaseModel())
            {
